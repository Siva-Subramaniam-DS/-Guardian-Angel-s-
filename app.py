...
CHANNEL_IDS = {
    "take_schedule": 1261575528457179196,
    "results": 1184579244202922144,
    "transcript": 1175720148259324017,
    "staff_attendance": 1197246999439867904
}
...
# Branding constants
ORGANIZATION_NAME = "♡ Guardian Angel's ♡ "
TOURNAMENT_SYSTEM_NAME = "♡ Guardian Angel's ♡ Tournament System"

# Role IDs for permissions
ROLE_IDS = {
    "judge": 1184587751916568666,
    # "recorder": 1302493626672091209,  # Commented out - not needed for now
    "head_helper": 1231372488789721128,
    "helper_team": 1184587759487303790,
    "head_organizer": 1184589302307487796
}
...
async def on_message(message):
    ...
    if command in ['?sh', '?dq', '?dd', '?ho']:
        ...
        response = await message.channel.send("https://challonge.com/The_Exodus_Oddesy")
...
async def add_captain(interaction: discord.Interaction, round: str, captain1: discord.Member, captain2: discord.Member, bracket: str = None):
    ...
    try:
        ...
        try:
            ...
            print("Warning: logo.png not found, skipping logo")
        except Exception as e:
        ...
        try:
            ...
            print("Warning: logo.png not found, sending embed without logo")
